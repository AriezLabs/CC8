...
void draw() {
    ...
    int i;
    int l;
    char line[192]; // █ etc. are non-ASCII chars (up to 3 bytes long), hence 64*3 bytes + 1 for \n
...
void init_mem() {
    ...
    // load digits...
    short digits[] = {0xF0, 0x90, 0x90, 0x90, 0xF0, 0x20, 0x60, 0x20, 0x20, 0x70, 0xF0, 0x10, 0xF0, 0x80, 0xF0, 0xF0,
